      ...
      <div className="row content">
        <div className="col-md-8 pt-4">
          ...
          <p>
            ...
            solution possible for the end user. I have a keen interest in using
            modern web technologies to create web applications that deliver a
            rich and fluid experience. I am a fast learner who is not afraid to
            jump straight into a project. I work well in a team, and enjoy
            connecting with the people I work with. I crave a good challenge,
            and I am always striving to expand my knowledge and techniques for
            the future.
          </p>
